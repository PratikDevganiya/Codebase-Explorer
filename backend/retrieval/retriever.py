...
class MultiStageRetriever:
    ...
    def _rerank_results(self, query: str, candidates: List[Dict]) -> List[Dict]:
        ...
        - Query term matching
        - Small exact query-term and symbol-name boosts
        ...
        for result in candidates:
            ...
            term_boost = min(term_matches * 0.02, 0.08)
            ...
            final_score = base_score + term_boost + name_boost
