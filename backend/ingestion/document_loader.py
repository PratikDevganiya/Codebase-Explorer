...
class DocumentLoader:
    ...
    def __init__(self):
        ...
        self.supported_extensions = dict(EXTENSION_LANGUAGES)
        self.supported_filenames = dict(FILENAME_LANGUAGES)
        logger.info(
    ...
    def load_file(self, file_path: Path) -> Optional[Document]:
        ...
        try:
            ...
            if (
                ...
                and file_path.name.lower() not in self.supported_filenames
            ):
