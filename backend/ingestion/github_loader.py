...
class GitHubLoader:
    ...
    def get_file_list(
        ...
        Args:
            ...
            filenames: Extensionless filenames to include (e.g., ['Dockerfile'])
        ...
        files = []
        normalized_filenames = {name.lower() for name in (filenames or [])}
        excluded_filenames = {
            "package-lock.json",
            "npm-shrinkwrap.json",
            "yarn.lock",
        ...
        for file_path in repo_path.rglob("*"):
            ...
            if (
                file_path.suffix.lower() not in extensions
                and file_path.name.lower() not in normalized_filenames
            ):
                continue
